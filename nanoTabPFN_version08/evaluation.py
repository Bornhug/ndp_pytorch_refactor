...
class NanoTabPFNClassifier:
    ...
    def __init__(
        ...
        Args:
            ...
            sampling_method: "direct" (single pass), "ddpm" (full), or "ddim" (subset)
            num_sampling_steps: Number of steps for DDIM (ignored for DDPM/direct)
...
def main():
    ...
    parser.add_argument(
        ...
        help="Inference method: direct (single pass), ddpm (full reverse), or ddim (subset)",
    )
    parser.add_argument(
        "--num-sampling-steps",
        type=int,
