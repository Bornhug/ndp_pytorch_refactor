...
class ModelConfig:
    ...
    num_features: int = 5
    num_outputs: int = 10  # max_classes (10)
...
class DiffusionConfig:
    ...
    beta_end: float = 0.5
    timesteps: int = 500
    model_prediction: str = "x_prev"  # "x_start" or "x_prev"
...
class TrainingConfig:
    ...
    # Evaluation settings
    eval_every: int = 500  # Run evaluation_ddim500 every N steps (0 = disabled)
    eval_sampling_method: str = "ddim"  # "ddpm" or "ddim"
    eval_sampling_steps: int = 50  # Number of steps for DDIM/DDPM sampling
